...
#ifdef DRIVER_ATL
#define adapter_struct atl_adapter
#endif
...
#define CONFIG_ATL1C_NAPI Y
#define netif_rx_complete(netdev, napi) netif_rx_complete(napi)
#define netif_rx_schedule_prep(netdev, napi) netif_rx_schedule_prep(napi)
#define netif_rx_schedule(netdev, napi) netif_rx_schedule(napi)
#define __netif_rx_schedule(netdev, napi) __netif_rx_schedule(napi)
#endif
